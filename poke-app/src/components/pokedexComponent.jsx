    ...
    <div>
      ...
      <div className="background-pokedex">
        ...
        <div className="user-interface">
          ...
          <div className="yellow-screen">{pokemon?.types.length > 1 ? (
              <div>
              ...
              <div>
                <p className="pokemon-types">Types : </p>
                <p className="pokemon-single-type">{pokemon?.types[0].type.name}</p>
              </div>
          ...
          <div
            ...
            onClick={switchToFirstPokemon}>
          </div>

          <div
            className="last-pokemon-button"
            onClick={switchToLastPokemon}>
          </div>
