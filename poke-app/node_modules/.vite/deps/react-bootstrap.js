...
var NavLink = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime42.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames28.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
...
var Overlay = React47.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime46.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime52.jsxs)(import_jsx_runtime51.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react38.cloneElement)(children, triggerProps), (0, import_jsx_runtime50.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
